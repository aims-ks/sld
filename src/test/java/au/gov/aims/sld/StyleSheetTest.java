...
public class StyleSheetTest {
	...
	public void testGenerateStyledLayers() throws Exception {
		...
		Assert.assertEquals("Wrong stroke colour.", new Color(169, 172, 173), _styledShape.getStrokePaint());
	}
	...
	public void testParserWithLineSymbolizer() throws Exception {
		...
		Assert.assertNull("Wrong fill colour.", _styledShape.getFillPaint());
		Assert.assertEquals("Wrong stroke colour.", new Color(39, 103, 135, 204), _styledShape.getStrokePaint());
	}
